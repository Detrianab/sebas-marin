...
ESTILO: Español formal y cercano. Respuestas breves (máximo 125 palabras).`;
    ...
    console.log(">>> RESPUESTA GENERADA PARA ADVISOR:", reply.substring(0, 50) + "...");

    // Cabeceras estrictas del protocolo Vercel AI SDK v1
    res.setHeader('Content-Type', 'text/plain; charset=utf-8');
    res.setHeader('X-Vercel-AI-Data-Stream', 'v1');
    res.setHeader('Transfer-Encoding', 'chunked');

    // Formato de chunks exacto que DefaultChatTransport de advisor-page.tsx procesa
